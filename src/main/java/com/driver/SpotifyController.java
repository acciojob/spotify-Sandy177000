...
public class SpotifyController {
    ...
    public String createAlbum(@RequestParam(name = "title") String title,
    ...
    public String createSong( @RequestParam(name = "title") String title,
        ...
        if(s==null) throw new Exception("Album does not exist");

        return "Success";
    }

    @PostMapping("/add-playlist-on-length")
    public String createPlaylistOnLength(@RequestParam(name = "mobile") String mobile,
        ...
        User u = spotifyService.findUser(mobile);
        if(u==null) throw new Exception("User does not exist");

        Playlist pl = spotifyService.createPlaylistOnLength(mobile,title,length);

        return "Success";
    }

    @PostMapping("/add-playlist-on-name")
    public String createPlaylistOnName(@RequestParam(name = "mobile")  String mobile,
                                       @RequestParam(name = "title") String title,
                                       @RequestParam(name = "songTitles") List<String> songTitles) throws Exception{
        ...
        Playlist pl = spotifyService.createPlaylistOnName(mobile,title,songTitles);

        return "Success";
    }

    @PutMapping("/find-playlist")
    public String findPlaylist(@RequestParam(name = "mobile") String mobile,
                               @RequestParam(name = "playlistTitle") String playlistTitle) throws Exception{
        ...
        Playlist pl = spotifyService.findPlaylist(mobile,playlistTitle);
        if(pl==null) throw new Exception("Playlist does not exist");

        return "Success";
    }

    @PutMapping("/like-song")
    public String likeSong(@RequestParam(name = "mobile")  String mobile,
                           @RequestParam(name = "songTitle")  String songTitle) throws Exception{
        ...
        Song s = spotifyService.findSong(songTitle);
